...
pub fn analyze_transaction_for_outpoint(
    ...
    for input in &tx.input {
        if &input.previous_output.txid == spent_txid && input.previous_output.vout == spent_vout {
...
mod tests {
    ...
    fn mock_owner_witness() -> Witness {
        ...
        let sig = vec![
            ...
            0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20, 0x02,
            0x20, // s value header
            ...
            0x37, 0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x01, // SIGHASH_ALL
        ];
